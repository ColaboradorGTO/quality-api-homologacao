...
const createFuncionarioLojaSchema = Joi.object({
    ...
    NOLOGIN: Joi.number().optional()
        .messages({
            "string.base": "NOLOGIN must be a number",
