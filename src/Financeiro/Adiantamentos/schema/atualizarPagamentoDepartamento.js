...
const schemaAtualizarPagamentoDepartamento = Joi.object({
    IDPAGAMENTO: Joi.number().required()
        .messages({
            "any.required": "IDPAGAMENTO é obrigatório",
            "number.base": "IDPAGAMENTO deve ser uma número"
        }),
...
export default schemaAtualizarPagamentoDepartamento;
