...
const atualizarStatusPedidoSchema = Joi.object({
    ...
    IDANDAMENTO: Joi.number().integer().required()
    .messages({
        'number.base': 'IDANDAMENTO deve ser um número inteiro',
        'any.required': 'ID do andamento é obrigatório'
    }),
...
export default atualizarStatusPedidoSchema;