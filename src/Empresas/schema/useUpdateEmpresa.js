...
const updateEmpresaSchema = Joi.object({
    ...
    STGRUPOEMPRESARIAL: Joi.number().integer().required()
        .messages({
            "number.base": "STGRUPOEMPRESARIAL must be a number",
            "any.required": "STGRUPOEMPRESARIAL is required field"
        }),
    ...
    NUUF: Joi.number().integer()
        .messages({
            "number.base": "NUUF must be a number",
            "any.required": "NUUF is required field"
        }),
    ...
    DTULTATUALIZACAO: Joi.string().allow("")
        .messages({
            "string.base": "DTULTATUALIZACAO must be a string",
        }),
